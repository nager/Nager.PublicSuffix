...
namespace Nager.PublicSuffix.UnitTest
{
    ...
    public class PublicSuffixTest
    {
        ...
        private DomainParser BuildDomainParser()
        {
            ...
            var ruleData = domainParser.LoadDataAsync("https://publicsuffix.org/list/effective_tld_names.dat").Result;
        ...
        {
            Assert.IsNotNull(_domainParser, "_domainParser is null");

            if (!string.IsNullOrEmpty(domain)) domain = domain.ToLowerInvariant();

            var domainData = _domainParser.Get(domain);
            if (domainData == null)
        ...
        public void ComprehensiveCheck()
        {
            ...
            _domainParser = BuildDomainParser();
            _domainParser.AddRule(new TldRule("*")); //Required for unlisted TLDs
